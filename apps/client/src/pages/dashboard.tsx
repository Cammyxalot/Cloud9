        ...
        <div className="grid grid-cols-[1fr,2fr] gap-8 w-full place-content-start">
              ...
              <div className="grid grid-cols-2 mt-4">
                ...
                <div>
                  ...
                  <p className="text-black text-xl">
                    {prettyBytes(userStorage.available * 1e3)}
                  </p>
                </div>
              </div>
            </div>
          ...
          <main className="bg-white/100 border-solid border-[1px] border-slate-200 px-6 py-5 rounded-xl max-h-screen overflow-auto">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4">
              Add your websites to the list below to enable access to them via
              the domain name.
            </p>
            <ul className="space-y-4">
              {websites.map((website, index) => {
                return (
                  <li key={index} className="flex gap-2 last:!mb-4">
                    <Input
                      type="text"
                      placeholder="Domain"
              ...
              <li>
                ...
                >
                  ...
                  <Button
                    type="submit"
                    disabled={
                      newWebsiteErrors.length > 0 ||
                      newWebsiteDomain.current.length === 0 ||
                      newWebsiteAccessPath.current.length === 0
                    }
                    className="w-full"
